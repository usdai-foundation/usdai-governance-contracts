...
Governor Quorum Fraction        4%          (fraction of token supply needed for successful proposal)
Governor Proposal Threshold     10 million  (amount of absolute token needed to make a proposal)
...
Proposal votes can be For, Abstain, Against. Quorum Fraction counts For and Abstain votes, but not Against votes.
...
TimelockController
    PROPOSER_ROLE   -> ChipGovernor
    EXECUTOR_ROLE   -> ChipGovernor
